...
class PaymentBoxes extends StatefulWidget {
  final Function(bool isSelected)? onPressed;
  final String? text;

  const PaymentBoxes({Key? key, this.onPressed, this.text}) : super(key: key);

  @override
  State<PaymentBoxes> createState() => _PaymentBoxesState();
}

class _PaymentBoxesState extends State<PaymentBoxes> {
